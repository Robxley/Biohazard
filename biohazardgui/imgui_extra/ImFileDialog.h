#pragma once
// https://github.com/dfranx/ImFileDialog/tree/main
#include <ctime>
#include <stack>
#include <string>
#include <thread>
...
namespace ifd {
	...
	public:
		...
		public:
			...
			std::function<void()> ReleaserImage;
		};

		std::function<bool(FileData&)> ImportImage;
		std::vector<std::string> m_iconableExtensions = {".png", ".jpg", ".jpeg",".bmp",".tif", ".tiff", ".pbm", ".pgm", ".ppm", ".tga" };
